...
import { base64_variants, crypto_generichash, crypto_sign_detached } from 'libsodium-wrappers';
...
const createSigningString = async (
  ...
  console.log("Object keys", Object.keys(sodium), typeof sodium.crypto_generichash)
