...
import * as onSelectResponse from "./mock/onSelectResponse.json";
import * as onSearchResponse from "./mock/onSearchResponse.json";
import * as onInitResponse from "./mock/onInitResponse.json";
import * as onConfirmResponse from "./mock/onConfirmResponse.json";
import * as onStatusResponse from "./mock/onStatusResponse.json";
dotenv.config();
...
export async function onSearchJob(body: any): Promise<any> {
  try {
    ...
    const response: any = await axios.post(`${gatewayUrl}/on_search`, payload, {
      headers,
    });
...
export async function selectJob(body: any): Promise<any> {
  try {
    ...
    if (jobNetwork != "local") {
      const headers = { "Content-Type": "application/JSON" };
      const res = await axios.post(`${gatewayUrl}/select`, payload, {
        headers,
      });
      response = res;
    }
...
export async function onSelectJob(body: any) {
  try {
    ...
    const response: any = await axios.post(`${gatewayUrl}/on_select`, payload, {
      headers,
    });
...
export async function initJob(body: any) {
  try {
    ...
    if (jobNetwork != "local") {
      const headers = { "Content-Type": "application/JSON" };
      const res = await axios.post(`${gatewayUrl}/init`, payload, { headers });
      response = res;
    }
...
export async function onInitJob(body: any) {
  try {
    ...
    const response: any = await axios.post(`${gatewayUrl}/on_init`, payload, {
      headers,
    });
...
export async function confirmJob(body: any): Promise<any> {
  try {
    ...
    if (jobNetwork != "local") {
      const headers = { "Content-Type": "application/JSON" };
      const res = await axios.post(`${gatewayUrl}/confirm`, payload, {
        headers,
      });
      response = res;
    }
...
export async function statusJob(body: any) {
  try {
    ...
    if (jobNetwork != "local") {
      const headers = { "Content-Type": "application/JSON" };
      const res = await axios.post(`${gatewayUrl}/status`, payload, {
        headers,
      });
      response = res;
    }
...
export async function onStatusJob(body: any) {
  try {
    ...
    const response: any = await axios.post(`${gatewayUrl}/on_status`, payload, {
      headers,
    });
